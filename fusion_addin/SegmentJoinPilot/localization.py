...
_TEXT = {
    'en': {
        'conical15': 'RoundConical15',
        'conical30': 'RoundConical30',
        'hex_conical15': 'HexConical15',
        'hex_conical30': 'HexConical30',
        'section_width': 'Width across flats at section',
        'section_diameter': 'Diameter at section',
        'taper_info': 'Fixed taper; end diameter / width across flats at least 50% of the section diameter / width across flats for a 3D-printing contact surface. No additional chamfer.',
        'taper_too_long': 'Too long: both ends must retain at least 50% of the section diameter / width across flats for a 3D-printing contact surface. Socket depth clearance is also checked. Maximum total length: {limit:.2f} mm. Shorten the connector or increase its diameter; check clearances.',
        ...
        'scope': 'Version {version}: round and hexagonal connectors with fixed 15° or 30° taper and length validation.',
    ...
    'de': {
        'conical15': 'RundKonisch15',
        'conical30': 'RundKonisch30',
        'hex_conical15': 'SechseckKonisch15',
        'hex_conical30': 'SechseckKonisch30',
        'section_width': 'Schlüsselweite an der Schnittkante',
        'section_diameter': 'Durchmesser an der Schnittkante',
        'taper_info': 'Feste Verjüngung; Enddurchmesser bzw. Schlüsselweite mindestens 50 % des Ausgangsmaßes für eine Auflagefläche beim 3D-Druck. Keine zusätzliche Einführfase.',
        'taper_too_long': 'Zu lang: Für eine Auflagefläche beim 3D-Druck muss Durchmesser bzw. Schlüsselweite an beiden Dübelenden mindestens 50 % des Ausgangsmaßes betragen. Das Tiefenspiel der Aufnahme wird ebenfalls geprüft. Maximale Gesamtlänge: {limit:.2f} mm. Dübel verkürzen oder Ausgangsmaß erhöhen; Spiel prüfen.',
        ...
        'scope': 'Version {version}: runde und sechseckige Verbinder mit fester 15°- oder 30°-Verjüngung und Längenprüfung.',
    ...
    'fr': {
        'conical15': 'RondConique15',
        'conical30': 'RondConique30',
        'hex_conical15': 'HexagonalConique15',
        'hex_conical30': 'HexagonalConique30',
        'section_width': 'Largeur entre plats à la coupe',
        'section_diameter': 'Diamètre à la coupe',
        'taper_info': 'Conicité fixe ; diamètre / largeur entre plats aux extrémités au moins égal à 50 % du diamètre / largeur entre plats à la coupe pour une surface d’appui en impression 3D. Sans chanfrein supplémentaire.',
        'taper_too_long': 'Trop long : les deux extrémités doivent conserver au moins 50 % du diamètre / largeur entre plats à la coupe pour une surface d’appui en impression 3D. Le jeu en profondeur est aussi vérifié. Longueur totale maximale : {limit:.2f} mm. Réduisez la longueur ou augmentez le diamètre / largeur entre plats ; vérifiez les jeux.',
        ...
        'scope': 'Version {version} : connecteurs ronds et hexagonaux avec conicité fixe de 15° ou 30° et contrôle de longueur.',
    ...
    'es': {
        'conical15': 'RedondoCónico15',
        'conical30': 'RedondoCónico30',
        'hex_conical15': 'HexagonalCónico15',
        'hex_conical30': 'HexagonalCónico30',
        'section_width': 'Ancho entre caras en el corte',
        'section_diameter': 'Diámetro en el corte',
        'taper_info': 'Conicidad fija; diámetro / ancho entre caras en los extremos de al menos el 50 % del diámetro / ancho entre caras en el corte para apoyar la impresión 3D. Sin chaflán adicional.',
        'taper_too_long': 'Demasiado largo: ambos extremos deben conservar al menos el 50 % del diámetro / ancho entre caras en el corte para apoyar la impresión 3D. También se comprueba la holgura de profundidad. Longitud total máxima: {limit:.2f} mm. Reduzca la longitud o aumente el diámetro / ancho entre caras; revise las holguras.',
        ...
        'scope': 'Versión {version}: conectores redondos y hexagonales con conicidad fija de 15° o 30° y validación de longitud.', 'validation': 'Validación', 'select_body_plane': 'Seleccione un cuerpo sólido y un plano de construcción.',
    ...
    'pl': {
        'conical15': 'OkrągłyStożkowy15',
        'conical30': 'OkrągłyStożkowy30',
        'hex_conical15': 'SześciokątnyStożkowy15',
        'hex_conical30': 'SześciokątnyStożkowy30',
        'section_width': 'Rozstaw płaskich ścian na przekroju',
        'section_diameter': 'Średnica na przekroju',
        'taper_info': 'Stałe zwężenie; średnica / rozstaw płaskich ścian końców co najmniej 50% średnicy / rozstawu płaskich ścian na przekroju zapewnia powierzchnię podparcia do druku 3D. Bez dodatkowej fazy.',
        'taper_too_long': 'Zbyt długi: oba końce muszą zachować co najmniej 50% średnicy / rozstawu płaskich ścian na przekroju, aby zapewnić powierzchnię podparcia do druku 3D. Sprawdzany jest także luz głębokości gniazda. Maksymalna długość całkowita: {limit:.2f} mm. Skróć łącznik lub zwiększ średnicę / rozstaw płaskich ścian; sprawdź luzy.',
        ...
        'scope': 'Wersja {version}: łączniki okrągłe i sześciokątne ze stałym zwężeniem 15° lub 30° oraz kontrolą długości.', 'validation': 'Walidacja', 'select_body_plane': 'Wybierz bryłę i płaszczyznę konstrukcyjną.',
